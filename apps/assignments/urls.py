...
# ]
from django.urls import path
from apps.assignments.api_endpoints.submission.views.submission_create_view import (
    SubmissionCreateAPIView,
)
from apps.assignments.api_endpoints.submission.views.submission_detail_view import (
    SubmissionDetailAPIView,
)
from apps.assignments.api_endpoints.assignments.views import (
